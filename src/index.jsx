  ...
  renderCalendar = () => {
    ...
    return (
      <WrappedCalendar
        ...
        headerDayClassName={this.props.headerDayClassName}
        headerCurrentMonthNamesClassName={
          this.props.headerCurrentMonthNamesClassName
        }
        headerCurrentMonthNameClassName={
          this.props.headerCurrentMonthNameClassName
        }
      >
        {this.props.children}
      </WrappedCalendar>
